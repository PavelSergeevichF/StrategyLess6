...
namespace UserControlSystem.UI.View
{
    public sealed class CommandButtonsView : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject _rendezvousPoint;
        ...
        private void Start()
        {
            ...
            _buttonsByExecutorType
                .Add(typeof(CommandExecutorBase<IRendezvousPoint>), _rendezvousPoint);
        }
        ...
        private void SetInteractible(bool value)
        {
            ...
            _rendezvousPoint.  GetComponent<Selectable>().interactable = value;
        }
